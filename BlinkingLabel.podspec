...
Pod::Spec.new do |s|
  ...
  s.license          = 'MIT'
  s.author           = { "Courtland Caldwell" => "caldwecr@gmail.com" }
  s.source           = { :git => "https://github.com/caldwecr/BlinkingLabel.git", :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/caldwecr'
